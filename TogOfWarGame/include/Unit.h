...
public:
	...
	Unit();
	///\brief Constructor
	///\prama float unit health
	///\prama float attack damage
	///\prama float movement speed 
	///\prama float gold dropped when killed
	///\prama float gold cost to build
	///\prama Sprite sprite
	...
	///\return float cost
	inline float getGoldCost()
	{ return m_cost; }

	///\brief get the unit gold drop
	///\return float drop
	inline float getGoldDrop()
	{ return m_drop; }
